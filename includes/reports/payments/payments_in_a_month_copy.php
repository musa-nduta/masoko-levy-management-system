...
$payment_report = mysql_query("SELECT COALESCE(SUM(amount_paid),0) as total from payments, market WHERE pay_date BETWEEN '$from' and '$to' and market.id = '".$rows['market_id']."'" ) or die(mysql_error());
