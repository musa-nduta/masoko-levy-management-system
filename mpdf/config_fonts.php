...
// $this->backupSubsFont = array('dejavusanscondensed','arialunicodems','sun-exta');	// this will recognise most scripts  'dejavusanscondensed',
$this->backupSubsFont = array('freeserif');
